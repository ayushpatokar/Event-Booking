...
const AdminDashboard = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto animate-fade-in-up">
            {/* Banner — changed from plain black to the indigo/purple/pink gradient used on Home/UserDashboard */}
            <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white rounded-2xl p-6 sm:p-8 mb-8 shadow-lg flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
                <div>
                ...
                {/* Changed: button now white-on-gradient like other CTA buttons, indigo text instead of black */}
                <button
            ...
            {/* Admin Stats Row — kept same layout, matches UserDashboard's stat card style */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
                    ...
                    <div className="w-12 h-12 bg-indigo-100 text-indigo-500 rounded-full flex items-center justify-center text-xl font-bold">👤</div>
                </div>
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
                    <div>
            ...
            {showEventForm && (
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mb-8 animation-slideDown">
                    ...
                    {/* Changed: all input focus rings from gray-700 to indigo-500, consistent with EventDetail's OTP input */}
                    <form onSubmit={handleCreateEvent} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Changed: submit button gray-900/black → gradient, matches Home/UserDashboard CTA buttons */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col">
                    <h2 className="text-2xl font-bold mb-6 text-gray-800 flex items-center gap-3">
                        {/* Changed: counter badge gray → light indigo tint, consistent accent */}
                        <span className="flex items-center justify-center w-8 h-8 rounded-full bg-indigo-100 text-indigo-700 text-sm font-bold">{events.length}</span>
                        All Events
                    </h2>
